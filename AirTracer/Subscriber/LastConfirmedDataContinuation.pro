...
<Protocol Name="Data Control Burst Message">
	...
	<Comment></Comment>
	<PDU Name="Last Confirmed Data Continuation" Size="24" SecondaryKeyField="6">
		<Comment></Comment>
		<Field Name="9-Bit CRC: Bit 8" Pos="0" Size="1" BitFlag="true" BitPos="0">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="DBSN - Data Block Serial Number" Pos="0" Size="7" BitFlag="true" BitPos="1">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="9-Bit CRC: Bit 0~7" Pos="1" Size="1" BitFlag="false">
			<Comment></Comment>
			<Data/>
		</Field>
