...
<Protocol Name="Sync Message">
	...
	<PDU Name="APCO I" Size="4" SecondaryKeyField="1">
		...
		<Field Name="Unused" Pos="1" Size="7" BitFlag="false">
			<Comment></Comment>
			<Data/>
		</Field>
	</PDU>
	...
	<PDU Name="LTD: Voice TLS1 SYNC MS Sourced" Size="4" SecondaryKeyField="1">
		<Comment></Comment>
		<Field Name="Sync Type" Pos="0" Size="1" BitFlag="false">
			<Comment></Comment>
			<Value Description="Voice TLS1 SYNC MS Sourced">0x000D<Comment></Comment></Value>
		</Field>
		<Field Name="Unused" Pos="1" Size="7" BitFlag="false">
			<Comment></Comment>
			<Data/>
	...
	<PDU Name="LTD: Data TLS1 SYNC MS Sourced" Size="4" SecondaryKeyField="1">
		<Comment></Comment>
		<Field Name="Sync Type" Pos="0" Size="1" BitFlag="false">
			<Comment></Comment>
			<Value Description="Data TLS1 SYNC MS Sourced">0x000E<Comment></Comment></Value>
		</Field>
		<Field Name="Unused" Pos="1" Size="7" BitFlag="false">
			<Comment></Comment>
			<Data/>
	...
	<PDU Name="LTD: Voice TLS2 SYNC MS Sourced" Size="4" SecondaryKeyField="1">
		<Comment></Comment>
		<Field Name="Sync Type" Pos="0" Size="1" BitFlag="false">
			<Comment></Comment>
			<Value Description="Voice TLS2 SYNC MS Sourced">0x000F<Comment></Comment></Value>
		</Field>
		<Field Name="Unused" Pos="1" Size="7" BitFlag="false">
			<Comment></Comment>
			<Data/>
	...
	<PDU Name="LTD: Data TLS2 SYNC MS Sourced" Size="4" SecondaryKeyField="1">
		<Comment></Comment>
		<Field Name="Sync Type" Pos="0" Size="1" BitFlag="false">
			<Comment></Comment>
			<Value Description="Data TLS2 SYNC MS Sourced">0x0010<Comment></Comment></Value>
		</Field>
		<Field Name="Unused" Pos="1" Size="7" BitFlag="false">
			<Comment></Comment>
			<Data/>
