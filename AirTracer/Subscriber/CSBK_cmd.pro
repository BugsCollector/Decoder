...
<Protocol Name="CSBK Message">
	...
	<PDU Name="Extended Function Command" Size="24" SecondaryKeyField="1">
		...
		<Field Name="Operand" Pos="10" Size="1" BitFlag="false">
			...
			<Value Description="IP Console Uninhibit">0x0081<Comment></Comment></Value>
			<Value Description="IP Console Inhibit">0x0082<Comment></Comment></Value>
		</Field>
	...
	<PDU Name="CPC Preamble CSBK" Size="24" SecondaryKeyField="1,4">
		...
		<Field Name="Reserved" Pos="2" Size="5" BitFlag="true" BitPos="0">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="Emergency Bit" Pos="2" Size="1" BitFlag="true" BitPos="6">
		...
		<Field Name="Group or Individual Call" Pos="2" Size="1" BitFlag="true" BitPos="7">
			<Comment></Comment>
			<Value Description="Individual Call">0x0000<Comment></Comment></Value>
			<Value Description="Group Call">0x0001<Comment></Comment></Value>
		</Field>
		<Field Name="Data or CSBK" Pos="2" Size="1" BitFlag="true" BitPos="8">
			<Comment></Comment>
			<Value Description="CSBK">0x0000<Comment></Comment></Value>
			<Value Description="Data">0x0001<Comment></Comment></Value>
		</Field>
		...
		<Field Name="Rest Channel ID" Pos="5" Size="1" BitFlag="false">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="Source Address" Pos="6" Size="2" BitFlag="false">
	...
	<PDU Name="Scheduled Window Announcement" Size="24" SecondaryKeyField="1">
		...
		<Field Name="Announcement SUID" Pos="2" Size="3" BitFlag="false">
			<Comment>This field indicates subscriber ID of radio which will transmit Data on next window.</Comment>
			<Value Description="Dummy Announcement">0xFFFE<Comment></Comment></Value>
		</Field>
		<Field Name="Announcement Window Number" Pos="3" Size="1" BitFlag="false">
			<Comment>This field indicates window number of next window.</Comment>
		</Field>
		<Field Name="Announcement Data Frame" Pos="4" Size="4" BitFlag="true" BitPos="0">
			<Comment>This field indicates the data frame to which the next window belongs.</Comment>
			<Data/>
		</Field>
		<Field Name="Grant Data Frame" Pos="4" Size="4" BitFlag="true" BitPos="4">
			<Comment>The first data frame where the granted window will start from.</Comment>
			<Data/>
		</Field>
		<Field Name="Grant Window Number" Pos="5" Size="1" BitFlag="false">
		...
		<Field Name="Grant Abbreviated SUID" Pos="6" Size="2" BitFlag="false">
	...
	<PDU Name="Window Grant" Size="24" SecondaryKeyField="1">
		...
		<Field Name="Grant SUID" Pos="2" Size="3" BitFlag="false">
			<Comment>Subscriber ID of radio that made the request for window.</Comment>
			<Data/>
		</Field>
		<Field Name="Grant Window Number" Pos="3" Size="1" BitFlag="false">
			<Comment>The window number that was granted to the requesting radio.</Comment>
			<Data/>
		</Field>
		<Field Name="Grant Data Frame" Pos="4" Size="4" BitFlag="true" BitPos="0">
			<Comment>The first data frame where the granted window will start from.</Comment>
			<Data/>
		</Field>
		<Field Name="Reserved_1" Pos="4" Size="4" BitFlag="true" BitPos="4">
			<Comment>Reserved field inserted by Motorola Internal AirTracer</Comment>
			<Data/>
		</Field>
		<Field Name="Reserved_2" Pos="5" Size="3" BitFlag="false">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="CRC" Pos="6" Size="2" BitFlag="false">
	...
	<PDU Name="CT_CSBK: Channel Timing CSBK" Size="24" SecondaryKeyField="1">
		<Comment></Comment>
		<Field Name="CSBKO" Pos="0" Size="6" BitFlag="true" BitPos="0">
			<Comment>Indicates Channel Timing (CT_CSBK).</Comment>
			<Value Description="CTCSBK">0x0007<Comment></Comment></Value>
		</Field>
		<Field Name="PF - Protected Flag" Pos="0" Size="1" BitFlag="true" BitPos="6">
			<Comment>This designates the protection mode for this CSBK.</Comment>
			<Value Description="Non-protected mode">0x0000<Comment></Comment></Value>
		...
		<Field Name="Motorola MFID" Pos="1" Size="1" BitFlag="false">
			<Comment></Comment>
			<Value Description="Standard MFID">0x0000<Comment></Comment></Value>
			<Value Description="Motorola Proprietary MFID">0x0010<Comment></Comment></Value>
		</Field>
		<Field Name="Sync Age MSB" Pos="2" Size="1" BitFlag="false">
			<Comment>This is the MSB portion (8-bits) of SyncAge. SyncAge is an 11-bit measurement of time from a timing leader beacon to the present moment, measured in SyncAgeIncrement ticks (0-2047).</Comment>
			<Data/>
		</Field>
		<Field Name="Generation" Pos="3" Size="5" BitFlag="true" BitPos="0">
			<Comment>Generation is a 5-bit field that indicates the min number of subscriber hops (0-31) incurred when propagating channel timing from the leader to a subcriber. It is used to prevent loopbacks in the propagation of channel timing.</Comment>
			<Data/>
		</Field>
		<Field Name="Sync Age LSB" Pos="3" Size="3" BitFlag="true" BitPos="5">
			<Comment>This is the LSB portion (3-bits) of SyncAge. SyncAge is an 11-bit measurement of time from a timing leader beacon to the present moment, measured in SyncAgeIncrement ticks (0-2047).</Comment>
			<Data/>
		</Field>
		<Field Name="Leader ID MSB" Pos="4" Size="1" BitFlag="false">
			<Comment>This is the MSB portion (8-bits) of Leader ID. The Leader ID field contains the least significant 15-bits of the 24-bit SUID belonging to the subscriber that is presently believed to be the timing leader.</Comment>
			<Data/>
		</Field>
		<Field Name="NL -  New Leader" Pos="5" Size="1" BitFlag="true" BitPos="0">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="Leader ID LSB" Pos="5" Size="7" BitFlag="true" BitPos="1">
			<Comment>This is the LSB portion (7-bits) of Leader ID. The Leader ID field contains the least significant 15-bits of the 24-bit SUID belonging to the subscriber that is presently believed to be the timing leader.</Comment>
			<Data/>
		</Field>
		<Field Name="Op1 - Opcode 1" Pos="6" Size="1" BitFlag="true" BitPos="0">
			<Comment>Opcode field comprises 2 bits. Opcode1 is the MSB portion and Opcode0 is the LSB portion. When Opcode1 is true, shall assumed to be following leader's timing. When false, shall assumed to not be following leader's timing.</Comment>
			<Data/>
		</Field>
		<Field Name="LDR DLI" Pos="6" Size="2" BitFlag="true" BitPos="1">
			<Comment></Comment>
			<Value Description="DLI_Exclude">0x0000<Comment></Comment></Value>
			<Value Description="DLI_Low_Pref">0x0001<Comment></Comment></Value>
			<Value Description="DLI_Normal_Pref">0x0002<Comment></Comment></Value>
			<Value Description="DLI_High_Pref">0x0003<Comment></Comment></Value>
		</Field>
		<Field Name="Leader ID Postfix" Pos="6" Size="5" BitFlag="true" BitPos="3">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="Source ID MSB" Pos="7" Size="1" BitFlag="false">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="Reserved" Pos="8" Size="1" BitFlag="true" BitPos="0">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="Source ID LSB" Pos="8" Size="7" BitFlag="true" BitPos="1">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="Op0 - Opcode 0" Pos="9" Size="1" BitFlag="true" BitPos="0">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="SRC DLI" Pos="9" Size="2" BitFlag="true" BitPos="1">
			<Comment>A 2-bit field that provides additional information used during leader selection. It characterizes a subscriber's ability and preferences to serve as a timing leader.</Comment>
			<Value Description="DLI_Exclude">0x0000<Comment></Comment></Value>
			<Value Description="DLI_Low_Pref">0x0001<Comment></Comment></Value>
			<Value Description="DLI_Normal_Pref">0x0002<Comment></Comment></Value>
			<Value Description="DLI_High_Pref">0x0003<Comment></Comment></Value>
		</Field>
		<Field Name="Source ID Postfix" Pos="9" Size="5" BitFlag="true" BitPos="3">
			<Comment></Comment>
			<Data/>
		</Field>
		<Field Name="CRC" Pos="10" Size="2" BitFlag="false">
