...
<Protocol Name="Neptune Short Link Control Messages">
	...
	<PDU Name="Developmental version of Control Channel Short LC(thru 1.14)" Size="8" SecondaryKeyField="8">
		<Comment></Comment>
		<Field Name="Network ID (MSB)" Pos="0" Size="1" BitFlag="false">
			<Comment>4095 Networks</Comment>
			<Data/>
	...
	<PDU Name="Trunking Channel Short LC" Size="8" SecondaryKeyField="7">
		<Comment></Comment>
		<Field Name="Network ID (MSB)" Pos="0" Size="1" BitFlag="false">
			<Comment>4095 Networks</Comment>
			<Data/>
	...
	<PDU Name="Control Channel PMON Short LC" Size="8" SecondaryKeyField="7">
		<Comment></Comment>
		<Field Name="Priority TGID (MSB)" Pos="0" Size="2" BitFlag="false">
			<Comment>High 16 Bit</Comment>
			<Data/>
		</Field>
		...
		<Field Name="Repeater ID" Pos="2" Size="4" BitFlag="true" BitPos="2">
			<Comment>4 Bit</Comment>
			<Data/>
		</Field>
		<Field Name="Priority TGID (LSB)" Pos="2" Size="2" BitFlag="true" BitPos="6">
			<Comment>High 2 Bit</Comment>
			<Data/>
		</Field>
		<Field Name="padding" Pos="3" Size="4" BitFlag="true" BitPos="0">
			<Comment>4 Bit padding</Comment>
			<Data/>
		</Field>
		<Field Name="CC PMON SLC Opcode" Pos="3" Size="4" BitFlag="true" BitPos="4">
			<Comment>SLCO, Shall be set to 1110</Comment>
			<Value Description="NEP_CC_PMON_SLC">0x000E<Comment></Comment></Value>
		</Field>
		<Field Name="Pad" Pos="4" Size="4" BitFlag="false">
			<Comment>4 Bytes</Comment>
			<Data/>
	...
	<PDU Name="Trunking Channel PMON Short LC" Size="8" SecondaryKeyField="7">
		<Comment></Comment>
		<Field Name="Priority TGID (MSB)" Pos="0" Size="2" BitFlag="false">
			<Comment>High 16 Bit</Comment>
			<Data/>
		...
		<Field Name="TC PMON SLC Opcode" Pos="3" Size="4" BitFlag="true" BitPos="4">
			<Comment>SLCO, Shall be set to 1111</Comment>
			<Value Description="NEP_TC_PMON_SLC">0x000F<Comment></Comment></Value>
		</Field>
		<Field Name="Pad" Pos="4" Size="4" BitFlag="false">
			<Comment>4 Bytes</Comment>
			<Data/>
